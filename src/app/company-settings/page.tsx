...
function CompanySettingsContent() {
  ...
  async function handleDeleteCompany() {
    ...
    const confirmed = confirm(
      `Are you sure you want to delete this company? This action cannot be undone and will delete all associated data.`
    );
    ...
    try {
      ...
      // Redirect to overview after deletion
      router.push("/overview");
    } catch (e: any) {
      console.error("Error deleting company:", e);
      alert("Error: " + (e?.message || "Failed to delete company"));
    } finally {
      setDeleting(false);
    }
  }
