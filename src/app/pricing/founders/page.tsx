...
export const metadata: Metadata = {
  title: "Founder Pricing - Valyxo",
  description:
    "Free early access for founders. Get investor-ready metrics, automated KPIs, and live dashboards while we build the most reliable investor-ready metrics platform.",
};

const foundersConfig = {
  heroTitle: "Founder Pricing",
  heroSubhead:
    "Free for now — we're in early access. We're looking for feedback so we can build the most reliable investor-ready metrics platform.",
  valueBullets: [
    "Auto-sync core metrics from your existing tools",
    "Share live dashboards with investors",
    "Cut down follow-up questions with one source of truth",
    "Track runway, burn, and MRR — always current",
  ],
  features: [
    "Automated KPI tracking and syncing",
    "Live investor dashboards",
  ...
  faq: [
    ...
    },
    {
      ...
      a: "We want to hear about what works, what doesn't, and what features would make Valyxo essential for your investor relations workflow.",
    },
    {
      q: "Is my data secure?",
    ...
    },
    {
      ...
      a: "Yes! Early access includes team collaboration features. You can invite team members to help manage your investor relations.",
    },
  ],
};
      ...
      <main className="overflow-x-clip pt-[68px]">
        ...
        <section className="relative mx-auto max-w-screen-xl px-4 pt-16 lg:pt-24 pb-12">
          <div className="mx-auto max-w-3xl text-center">
            <h1 className="text-4xl lg:text-5xl font-medium mb-6">{foundersConfig.heroTitle}</h1>
            <p className="text-lg lg:text-xl text-white/80 max-w-2xl mx-auto">
              {foundersConfig.heroSubhead}
            </p>
          </div>
        </section>
            ...
            <div className="bg-gradient-to-b from-black/50 to-black/30 border border-white/10 rounded-lg p-8 lg:p-12">
              ...
              <div className="mb-12">
                ...
                <ul className="space-y-4">
                  {foundersConfig.valueBullets.map((bullet, i) => (
              ...
              <div className="mb-12">
                ...
                <ul className="space-y-3">
                  {foundersConfig.features.map((feature, i) => (
        ...
        <section className="relative mx-auto max-w-screen-xl px-4 pb-16">
          <div className="mx-auto max-w-3xl">
            <div className="bg-gradient-to-b from-black/30 to-black/20 border border-white/10 rounded-lg p-8 lg:p-12">
              ...
              <p className="text-white/80 text-lg leading-relaxed">{foundersConfig.whyFree}</p>
            </div>
          </div>
        </section>
