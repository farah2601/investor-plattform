...
export function TrackingScripts() {
  return (
    <>
      ...
      {/* Google Analytics */}
      <Script
        src="https://www.googletagmanager.com/gtag/js?id=G-06SLWZJG92"
        strategy="afterInteractive"
      />
      ...
      <Script
        id="hs-script-loader"
        src="https://js.hs-scripts.com/852744.js"
        strategy="afterInteractive"
      />
          ...
          (function(){
            ...
            if(typeof ic==="function"){
              ...
              var l=function(){
                ...
                s.async=true;
                s.src='https://widget.intercom.io/widget/be6a921d4eef18cb744d2fbfc9952d8e9e64213b';
